...
DarknessEnergyDescription:
	text "Provides <DARKNESS> Energy. (Doesn't count as"
	line "a basic Energy card.) If the Pokémon Darkness"
	line "Energy is attached to damages the Defending"
	line "Pokémon, the attack does 10 more damage to the"
	line "Defending Pokémon. At the end of every turn, put"
	line "1 damage counter on the Pokémon Darkness Energy"
	line "is attached to unless it's <DARKNESS>."
	done
...
MetalEnergyDescription:
	text "Provides <METAL> Energy. (Doesn't count as"
	line "a basic Energy card.) Damage done to the Pokémon"
	line "Metal Energy is attached to is reduced"
	line "by 10 (after applying Weakness and Resistance)."
	line "If the Pokémon Metal Energy is attached to isn't"
	line "<METAL>, whenever it damages a Pokémon, reduce"
	line "that damage by 10."
	done
...
RecycleEnergyDescription:
    text "Recycle Energy provides <COLORLESS>"
    line "Energy. (Doesn't count as a basic"
    line "Energy card.) If this card is put"
    line "into your discard pile from play,"
...
SpinAttackDescription:
    text "Caterpie does 10 damage to itself."
    done

CaterpieDescription:
    text "For protection, it releases a"
    line "horrible stench from the antennae"
    line "on its head to drive away enemies."
    done
...
HardenDescription:
    ...
    line "to Metapod (after applying"
...
HatchDescription:
    ...
    line "damage counters from Metapod."
    line "Then, search your deck for a card"
    line "that evolves from Metapod and"
    line "attach that card to Metapod. This"
    line "counts as evolving Metapod."
...
MetapodDescription:
    ...
    line "weak as it prepares to evolve. It"
    line "stays motionless in the shell."
    done
...
MagicDustDescription:
    text "Flip a coin. If heads, the"
    line "Defending Pokémon is now either"
    line "Asleep, Confused, Paralyzed, or"
    line "Poisoned (your choice)."
    done
...
HyperReverseDescription:
    text "Does 10 damage times the number of"
    line "Energy attached to the Defending"
    line "Pokémon. After doing damage,"
    line "remove a number of damage counters"
    line "from Butterfree equal to the"
    line "amount of damage done to the"
...
ButterfreeDescription:
    text "It collects honey every day. It"
    line "rubs honey onto the hairs on its"
    line "legs to carry it back to its nest."
    done
...
WeedleDescription:
    text "Its poison stinger is very"
    line "powerful. Its bright-colored body"
    line "is intended to warn off enemies."
    done
...
SecretePoisonDescription:
    text "During your opponent's next turn,"
    line "whenever your opponent's attack"
    line "damages Kakuna (even if Kakuna is"
    line "Knocked Out), your opponent's"
    line "Active Pokémon is now Poisoned and"
    line "Kakuna does 10 damage to each of"
    line "your opponent's Benched Pokémon."
    done

KakunaDescription:
    text "Although it is a cocoon, it can"
    line "move a little. It can extend its"
    line "poison barb if it is attacked."
    done
...
TriplePoisonDescription:
    text "Flip a coin. If heads, the"
    line "Defending Pokémon is now Poisoned."
    line "Your opponent now puts 3 damage"
    line "counters on it instead of 1 after"
    line "each player's turn (even if it was"
...
BeedrillDescription:
    text "It can take down any opponent with"
    line "its powerful poison stingers. It"
    line "sometimes attacks in swarms."
    done
