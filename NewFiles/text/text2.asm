...
CyndaquilAndFriendsDeckName: ; 3b44d (e:744d)
	text "Cyndaquil & Friends"
	done

CyndaquilExtraDeckName: ; 3b463 (e:7463)
	text "Cyndaquil extra"
	done

TotodileAndFriendsDeckName: ; 3b475 (e:7475)
	text "Totodile & Friends"
	done

TotodileExtraDeckName: ; 3b489 (e:7489)
	text "Totodile extra"
	done
...
RiversideDeckName: ; 3b4bf (e:74bf)
	text "Riverside"
	done

AuguryDeckName: ; 3b4cd (e:74cd)
	text "Augury"
	done

MemoriesOfYouthDeckName: ; 3b4db (e:74db)
	text "Memories Of Youth"
	done

EcholocationDeckName: ; 3b4ed (e:74ed)
	text "Echolocation"
	done

EeveelutionsDeckName:; 3b503 (e:7503)
	text "Eeveelutions"
	done

PredatorDeckName: ; 3b511 (e:7511)
	text "Predator"
	done

ExcavationDeckName: ; 3b523 (e:7523)
	text "Excavation"
	done

DamageVariationDeckName: ; 3b537 (e:7537)
	text "Fire Charge"
	done

LegendaryEnteiDeckName: ; 3b544 (e:7544)
	text "Legendary Entei"
	done

LegendaryRaikouDeckName: ; 3b557 (e:7557)
	text "Legendary Raikou"
	done

LegendarySuicuneDeckName: ; 3b569 (e:7569)
	text "Legendary Suicune"
	done

LugiaAndHoOhDeckName: ; 3b57d (e:757d)
	text "Lugia & Ho-Oh"
	done
...
VersatilityDeckName: ; 3b5d5 (e:75d5)
	text "Versatility"
	done

CertainDeathDeckName: ; 3b5e9 (e:75e9)
	text "Certain Death"
	done

ToxicSpikesDeckName: ; 3b5f9 (e:75f9)
	text "Toxic Spikes"
	done

CephalopodDeckName: ; 3b60d (e:760d)
	text "Cephalopod"
	done

MonstrosityDeckName: ; 3b614 (e:7614)
	text "Monstrosity"
	done

EnergyManipulationDeckName: ; 3b622 (e:7622)
	text "Energy Manipulation"
	done

DefibrillationDeckName: ; 3b62d (e:762d)
	text "Defibrillation"
	done

MetamorphosisDeckName: ; 3b639 (e:7639)
	text "Metamorphosis"
	done

DancePlantsDeckName: ; 3b64d (e:764d)
	text "Dance Plants"
	done

BenchHazardDeckName: ; 3b665 (e:7665)
	text "Bench Hazard"
	done

WaterMemoryDeckName: ; 3b674 (e:7674)
	text "Water Memory"
	done

InvincibilityDeckName: ; 3b682 (e:7682)
	text "Invincibility"
	done

GardeningDeckName: ; 3b696 (e:7696)
	text "Gardening"
	done

BabylutionsDeckName: ; 3b6a5 (e:76a5)
	text "Babylutions"
	done

BenchLuckDeckName: ; 3b6b5 (e:76b5)
	text "Bench Luck"
	done

BabySpinnerDeckName: ; 3b6be (e:76be)
	text "BabySpinner"
	done

CambrianHustleDeckName: ; 3b6d6 (e:76d6)
	text "Cambrian Hustle"
	done

BlisseyStallDeckName: ; 3b6e7 (e:76e7)
	text "Blissey Stall"
	done

NoRetreatDeckName: ; 3b6ee (e:76ee)
	text "No Retreat"
	done

OvertideDeckName: ; 3b6f8 (e:76f8)
	text "Overtide"
	done

ElectromagneticDeckName: ; 3b707 (e:7707)
	text "Electromagnetic"
	done

FlamethrowerDeckName: ; 3b717 (e:7717)
	text "Flamethrower"
	done

EarthquakeDeckName: ; 3b727 (e:7727)
	text "Earthquake"
	done
