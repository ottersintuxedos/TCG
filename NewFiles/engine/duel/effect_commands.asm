...
CrossAttackEffectCommands:
    dbw EFFECTCMDTYPE_BEFORE_DAMAGE, QuadrupleX20_MultiplierEffect
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, ???
    db  $00
...
10Plus10AttackEffectCommands:
    dbw EFFECTCMDTYPE_BEFORE_DAMAGE, 10Plus10Attack_DamageBoostEffect
	dbw EFFECTCMDTYPE_AI, 10Plus10Attack_AIEffect
    db  $00
