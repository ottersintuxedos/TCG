...
DUELVARS_ARENA_CARD_ATTACHED_MAGNIFIER    EQUS "LOW(wPlayerArenaCardAttachedMagnifier)"  ; e0
DUELVARS_BENCH1_CARD_ATTACHED_MAGNIFIER   EQUS "LOW(wPlayerBench1CardAttachedMagnifier)" ; e1
DUELVARS_BENCH2_CARD_ATTACHED_MAGNIFIER   EQUS "LOW(wPlayerBench2CardAttachedMagnifier)" ; e2
DUELVARS_BENCH3_CARD_ATTACHED_MAGNIFIER   EQUS "LOW(wPlayerBench3CardAttachedMagnifier)" ; e3
DUELVARS_BENCH4_CARD_ATTACHED_MAGNIFIER   EQUS "LOW(wPlayerBench4CardAttachedMagnifier)" ; e4
DUELVARS_BENCH5_CARD_ATTACHED_MAGNIFIER   EQUS "LOW(wPlayerBench5CardAttachedMagnifier)" ; e5
