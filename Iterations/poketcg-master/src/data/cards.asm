...
CaterpieCard: ; 30e28 (c:4e28)
	...
	dw AmpharosGigasparkEffectCommands ; effect commands
	db NONE ; flags 1
...
HeracrossCard: ; 30f6d (c:4f6d)
	...
	db 60 ; damage
	db DAMAGE_NORMAL ; category
	dw HeracrossMegahornEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
Jumpluff1Card: ; 30fae (c:4fae)
	...
	tx JumpluffsLeechSeedDescription ; description
	tx NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw JumpluffsLeechSeedEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 2
...
SteelixCard: ; 31175 (c:5175)
	...
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw SteelixsTailCrushEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
TogeticCard: ; 311b6 (c:51b6)
	...
	tx SuperMetronome1Description ; description
	dw SuperMetronome2Description ; description (cont)
	db NONE ; damage
	db DAMAGE_PLUS ; category
	dw TogeticsSuperMetronomeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw TogeticsFlyEffectCommand ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
SneaselCard: ; 313be (c:53be)
	...
	tx FurySwipesDescription ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db POKEMON_X ; category
	dw SneaselsFurySwipesEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 1
...
AipomCard: ; 313ff (c:53ff)
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw AipomsPilferEffectComands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	tx TailWhipX2Description ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_X ; category
	dw AipomsTailWhipEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
FlaaffyCard: ; 31607 (c:5607)
	...
	; attack 1
	energy ELECTRIC, 1 ; energies
	tx DischargeName ; name
	tx DischargeDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db DAMAGE_X ; category
	dw FlaaffysDischargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	tx FlaaffysElectricCurrentDescription ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_NORMAL ; category
...
FurretCard: ; 31648 (c:5648)
	...
	energy COLORLESS, 3 ; energies
	tx SlamName ; name
	tx FurretsSlamDescription ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw FurretsSlamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 1
...
GranbullCard: ; 316ca (c:56ca)
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw TackleEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	; attack 2
	energy COLORLESS, 3 ; energies
	dw RagingChargeName ; name
	dw RagingChargeDescription ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw GranbullsRagingChargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
LanturnCard: ; 3170b (c:570b)
	...
	db 3, 11 ; length
	dw 50 * 10 ; weight
	tx LanturnDescription ; description
	db 0
...
MiltankCard: ; 317ce (c:57ce)
	...
	dw NONE ; description (cont)
	db 0 ; damage
	db HEAL_USER ; category
	dw MiltanksMilkDrinkEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw MiltanksBodySlamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
Skiploom1Card: ; 319d6 (c:59d6)
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SkiploomsPoisonpowderEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	; attack 2
	energy GRASS, 0 ; energies
	dw StunSporeName ; name
	dw MayInflictParalysisDescription ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SkiploomsStunSporeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
TogepiCard: ; 31a58 (c:5a58)
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw PoisonBarbEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 3
...
XatuCard: ; 31a99 (c:5a99)
	...
	db 80 ; hp
	db STAGE1 ; stage
	dw NatuName ; pre-evo name

	; attack 1
	energy PSYCHIC, 1 ; energies
	tx ProphecyName ; name
	dw ProphecyDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	...
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw XatuConfuseRayEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
Chikorita1Card: ; 31ada (c:5ada)
	...
	tx ChikoritasDeflectorDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
...
ChinchouCard: ; 31b5c (c:5b5c)
	...
	db 1, 8 ; length
	dw 26 * 10 ; weight
	tx ChinchouDescription ; description
	db 3
...
GirafarigCard: ; 31c1f (c:5c1f)
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw GirafarigPsybeamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
HoothootCard: ; 31ca1 (c:5ca1)
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw HoothootHypnosisEffectCommands ; effect commands
	db INFLICT_SLEEP ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
HorseaCard: ; 31d23 (c:5d23)
	...
	db 1, 4 ; length
	dw 18 * 10 ; weight
	tx Horsea1Description ; description
	db 0
...
Natu1Card: ; 31e68 (c:5e68)
	...
	; attack 2
	energy PSYCHIC, 2 ; energies
	tx TelekenesisName ; name
	tx NatusTelekenesisDescription ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_TO_OPPONENT_BENCH ; category
	dw NatuTelekenesisEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 3
...
Oddish2Card: ; 31ea9 (c:5ea9)
	db TYPE_PKMN_GRASS type
	gfx Oddish2CardGfx ; gfx
	tx OddishName ; name
	db CIRCLE ; rarity
	db LABORATORY | FOSSIL ; sets
	db ODDISH1
	...
	db 0 ; damage
	db RESIDUAL ; category
	dw OddishHideEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE; fl+
	ags 2
	db NONE ; flags 3
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw OddishAbsorbEffectCommands ; effect commands
	db NONE ; flags 1
	db HEAL_USER ; flags 2
	db NONE ; flags 3
	db 2
	...
	db 1, 8 ; length
	dw 12 * 10 ; weight
	tx Oddish2Description ; description
	db 19
...
Pikachu5Card: ; 31f2b (c:5f2b)
	db TYPE_PKMN_ELECTRIC ; type
	gfx Pikachu5CardGfx ; gfx
	tx PikachuName ; name
	db CIRCLE ; rarity
	db COLOSSEUM | NONE ; sets
	db PIKACHU5
	...
	; attack 2
	energy ELECTRIC, 2, COLORLESS, 1 ; energies
	tx AgilityName ; name
...
Slowpoke3Card: ; 31fee (c:5fee)
	db TYPE_PKMN_PSYCHIC ; type
	gfx Slowpoke3CardGfx ; gfx
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SlowpokePsyshockEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 3, 11 ; length
	dw 79 * 10 ; weight
	tx Slowpoke3Description ; description
	db 0
...
Snubbull1Card: ; 3202f (c:602f)
	...
	energy COLORLESS, 1 ; energies
	tx RoarName ; name
	tx SubbullsRoarDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw SnubbullRoarEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SnubbullLickEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
GranbullCard: ; 316ca (c:56ca)
	...
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw GranbullRagingChargeEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
FurretCard: ; 31648 (c:5648)
	...
	db 20 ; damage
	db DAMAGE_X ; category
	dw WooperSlamEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 1
...
Marill1Card: ; 31e27 (c:5e27)
	...
	energy WATER, 2, COLORLESS, 1 ; energies
	tx BubbleBombName ; name
	tx MarillBubbleBombDescription ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw MarillBubbleBombEffectCommands ; effect commands
...
Oddish2Card: ; 31ea9 (c:5ea9)
	...
	energy GRASS, 2 ; energies
	tx AbsorbName ; name
	tx OddishsAbsorbDescription ; description
	tx OddishsAbsorbDescriptionCont ; description (cont)
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw KabutopsAbsorbEffectCommands ; effect commands
	db NONE ; flags 1
