...
JohtoDemoDescriptionText: ; 3d0ed (f:50ed)
	text "A Psychic, Grass and Water Deck:"
	line "Chikorita, Wooper and Natu"
	done
...
JohtoDemoDeckChoiceText: ; 3f982 (f:7982)
	text "Johto Demo Deck"
	done
