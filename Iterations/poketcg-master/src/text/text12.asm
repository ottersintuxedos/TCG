...
MarillName: ; 618c5 (18:58c5)
	text "Marill"
	done

AquamouseName: ; 618ce (18:58ce)
	text "Aquamouse"
	done

Marill1Description: ; 618d3 (18:58d3)
	text "The end of its tail serves as a buoy"
	line "that keeps it from drowning, even"
	line "in a vicious current."
	done

AzumarillName: ; 6192f (18:592f)
	text "Azumarill"
	done

SentretName: ; 61939 (18:5939)
	text "Sentret"
	done

Sentret1Description: ; 61945 (18:5945)
	text "A very cautious Pokémon, it raises"
	line "itself up using its tail to get a"
	line "better view of its surroundings."
	done

AzumarillDescription: ; 619be (18:59be)
	text "By keeping still and listening"
	line "intently, it can tell what is in even"
	line "wild, fast-moving rivers."
	done
...
BubbleBombName: ; 6227c (18:627c)
	text "Bubble Bomb"
	done

BubbleBombDescription: ; 62287 (18:6287)
	text "Flip a coin. If heads, the Defending"
...
Oddish2Description: ; 62366 (18:6366)
