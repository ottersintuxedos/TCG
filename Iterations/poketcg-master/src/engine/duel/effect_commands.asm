...
GigasparkEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, AzumarillBubbleShower_BenchDamage50PercentEffect
...
Bayleef2PoisonPowderEffectCommands:
	dbw EFFECTCMDTYPE_AI, Bayleef2PoisonPowder_AIEffect

HoppipSproutEffectCommands:
	dbw EFFECTCMDTYPE_INITIAL_EFFECT_1, HoppipSprout_CheckDeckAndPlayArea
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, HoppipSprout_PutInPlayAreaEffect
	dbw EFFECTCMDTYPE_REQUIRE_SELECTION, HoppipSprout_PlayerSelectEffect
	dbw EFFECTCMDTYPE_AI_SELECTION, HoppipSprout_AISelectEffect
	db  $00

SunflorasPetalDanceEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, SunfloraPetalDance_MultiplierEffect
	dbw EFFECTCMDTYPE_AI, SunfloraPetalDance_AIEffect
	db  $00

LedybaCometPunchEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, LedybaCometPunch_MultiplierEffect
	dbw EFFECTCMDTYPE_AI, LedybaCometPunch_AIEffect
	db  $00

GranbullRagingChargeEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, GranbullRagingCharge_DamageBoostEffect
	dbw EFFECTCMDTYPE_AI, GranbullRagingCharge_AIEffect
	db $00

MarillBubbleBombEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, MarillBubbleBomb_Recoil50PercentEffect
	db  $00

KingdraDragonTornadoEffectCommands:

ChikoritaDeflectorEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, Chikorita1DeflectorEffect
	db  $00

WooperSlamEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, WooperSlam_MultiplierEffect
	dbw EFFECTCMDTYPE_AI, WooperSlam_AIEffect
	db  $00
