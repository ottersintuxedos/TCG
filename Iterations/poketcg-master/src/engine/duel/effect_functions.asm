...
QuickAttack_AIEffect: ; 2d385 (b:5385)
	ld a, (10 + 30) / 2
	lb de, 10, 30
	jp SetExpectedAIDamage

QuickAttack_DamageBoostEffect: ; 2d38d (b:538d)
	ld hl, 20
	call LoadTxRam3
...
Flamethrower_CheckEnergy: ; 2d363 (b:5363)
	ld e, PLAY_AREA_ARENA
	call GetPlayAreaCardAttachedEnergies
...
Flamethrower_PlayerSelectEffect: ; 2d371 (b:5371)
	call PlayerPickFireEnergyCardToDiscard
	ret

Flamethrower_AISelectEffect: ; 2d375 (b:5375)
	call AIPickFireEnergyCardToDiscard
	ret

Flamethrower_DiscardEffect: ; 2d379 (b:5379)
	ldh a, [hTempList]
	call PutCardInDiscardPile
	ret
...
; Chikorita
Chikorita1DeflectorEffect: ; 2e3ba (b:63ba)
	ld a, SUBSTATUS1_HALVE_DAMAGE
	call ApplySubstatus1ToDefendingCard
	ret


Bayleef1TwinRazorLeaf_AIEffect: ; 2c7ed (b:47ed)
	ld a, 80 / 2
	lb de, 0, 80
	jp SetExpectedAIDamage

; Flip 2 coins; deal 40x number of heads
Bayleef1TwinRazorLeaf_MultiplierEffect: ; 2c7f5 (b:47f5)
	ld hl, 40
	call LoadTxRam3
	ldtx de, DamageCheckIfHeadsXDamageText
	ld a, 2
...
Bayleef2PoisonPowder_AIEffect: ; 2cb2f (b:4b2f)
	ld a, 10
	lb de, 10, 10
	jp UpdateExpectedAIDamage_AccountForPoison

; Still to add Pollen Shield and both Maganium's Powers

; Cyndaquil1 - function will exist anyway, unsure about Swift
...
; Hoppip's Sprout_
HoppipSprout_CheckDeckAndPlayArea: ; 2c84a (b:484a)
	call CheckIfDeckIsEmpty
	ret c ; return if no cards in deck
	ld a, DUELVARS_NUMBER_OF_POKEMON_IN_PLAY_AREA
	call GetTurnDuelistVariable
...
HoppipSprout_PlayerSelectEffect: ; 2c85a (b:485a)
	ld a, $ff
	ldh [hTemp_ffa0], a

	call CreateDeckCardList
	ldtx hl, ChooseAHoppipFromDeckText ; Will need to add this
	ldtx bc, HoppipName ; Should be in
	lb de, SEARCHEFFECT_CARD_ID, HOPPIP1
	call LookForCardsInDeck
	ret c
...
HoppipSprout_AISelectEffect: ; 2c8b7 (b:48b7)
	call CreateDeckCardList
	ld hl, wDuelTempList
.loop_deck
	ld a, [hli]
...
HoppipSprout_PutInPlayAreaEffect: ; 2c8cc (b:48cc)
	ldh a, [hTemp_ffa0]
	cp $ff
	jr z, .shuffle
	call SearchCardInDeckAndAddToHand
...
; Still to add Sunkern's Growth

SunfloraPetalDance_AIEffect: ; 2ce23 (b:4e23)
	ld a, 90 / 2
	lb de, 0, 90
	jp SetExpectedAIDamage

SunfloraPetalDance_MultiplierEffect: ; 2ce2b (b:4e2b)
	ld hl, 30
	call LoadTxRam3
	ldtx de, DamageCheckIfHeadsXDamageText
	ld a, 3
...
OddishHideEffect: ; you migh need another animation
	ldtx de, IfHeadsDoNotReceiveDamageOrEffectText
	call TossCoin_BankB
	ret nc ; return if tails
	ld a, SUBSTATUS1_AGILITY
...
LedybaCometPunch_AIEffect: ; 2eb5d (b:6b5d)
	ld a, (10 * 4) / 2
	lb de, 0, 40
	jp SetExpectedAIDamage

LedybaCometPunch_MultiplierEffect: ; 2d01e (b:501e)
	ld hl, 10
	call LoadTxRam3
	ldtx de, DamageCheckIfHeadsXDamageText
	ld a, 4
...
GranbullRagingCharge_AIEffect: ; 2d638 (b:5638)
	call GranbullRagingCharge_DamageBoostEffect
	jp SetDefiniteAIDamage

GranbullRagingCharge_DamageBoostEffect: ; 2d63e (b:563e)
	ld e, PLAY_AREA_ARENA
	call GetCardDamageAndMaxHP
	call AddToDamage
    ld a, 20
...
WooperSlam_AIEffect: ; 2ec0c (b:6c0c)
	ld a, (20 * 2) / 2
	lb de, 0, 40
	jp SetExpectedAIDamage

WooperSlam_MultiplierEffect: ; 2ec14 (b:6c14)
	ld hl, 20
	call LoadTxRam3
	ld a, 2
	ldtx de, DamageCheckIfHeadsXDamageText
...
MarillBubbleBomb_Recoil50PercentEffect: ; paralysis chance needs adding to heads outcome
	ld hl, 30
	call LoadTxRam3
	ldtx de, IfTailsDamageToYourselfTooText
	call TossCoin_BankB
...
AzumarillBubbleShower_BenchDamage50PercentEffect: ; 2d266 (b:5266)
	ldtx de, DamageToOppBenchAndParaIfHeadsText
	call TossCoin_BankB
	jr c, .heads
...
; Need to add Piloswine's Freeze
