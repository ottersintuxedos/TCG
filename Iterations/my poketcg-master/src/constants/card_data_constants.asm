...
TYPE_ENERGY EQU const_value
	...
	const TYPE_ENERGY_METAL			   ; $0e
	const TYPE_ENERGY_DARKNESS		   ; $0f
	const TYPE_ENERGY_DOUBLE_COLORLESS ; $10
	const TYPE_ENERGY_UNUSED           ; $11
	const TYPE_TRAINER                 ; $12
	const TYPE_TRAINER_UNUSED          ; $13
