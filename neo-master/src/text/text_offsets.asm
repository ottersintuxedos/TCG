...
TextOffsets:: ; 34000 (d:4000)
	...
	textpointer TotodileAndFriendsDeckName                         ; 0x01e2
	textpointer TotodileExtraDeckName                              ; 0x01e3
	textpointer ChikoritaAndFriendsDeckName                        ; 0x01e4
	textpointer ChikoritaExtraDeckName                             ; 0x01e5
	textpointer RiversideDeckName                                  ; 0x01e6
	textpointer AuguryDeckName                               	   ; 0x01e7
	textpointer MemoriesOfYouthDeckName                            ; 0x01e8
	textpointer EcholocationDeckName                        	   ; 0x01e9
	textpointer EeveelutionsDeckName                               ; 0x01ea
	textpointer PredatorDeckName                            	   ; 0x01eb
	textpointer ExcavationDeckName                                 ; 0x01ec
	textpointer DamageVariationDeckName                            ; 0x01ed
	textpointer LegendaryEnteiDeckName                             ; 0x01ee
	textpointer LegendaryRaikouDeckName                            ; 0x01ef
	textpointer LegendarySuicuneDeckName                           ; 0x01f0
	textpointer LugiaAndHoOhDeckName                               ; 0x01f1
	...
	textpointer VeratilityPokemonDeckName                          ; 0x01f6
	textpointer CertainDeathDeckName                               ; 0x01f7
	textpointer ToxicSpikesDeckName                            	   ; 0x01f8
	textpointer CephalopodDeckName                                 ; 0x01f9
	textpointer MonstrosityDeckName                                ; 0x01fa
	textpointer EnergyManipulationDeckName                         ; 0x01fb
	textpointer DefibrilationDeckName                              ; 0x01fc
	textpointer MetamorphosisDeckName                          	   ; 0x01fd
	textpointer DancePlantsDeckName                                ; 0x01fe
	textpointer BenchHazardDeckName                                ; 0x0200
	textpointer WaterMemoryDeckName                                ; 0x0201
	textpointer InvincibilityDeckName                              ; 0x0202
	textpointer GardeningDeckName                                  ; 0x0203
	textpointer BabylutionsDeckName                                ; 0x0204
	textpointer BenchLuckDeckName                                  ; 0x0205
	textpointer BabySpinnerDeckName                       		   ; 0x0206
	textpointer CambrianHustleDeckName                             ; 0x0207
	textpointer BlisseyStallDeckName                               ; 0x0208
	textpointer NoRetreatDeckName                                  ; 0x0209
	textpointer OvertideDeckName	   							   ; 0x020a
	textpointer ElectromagneticDeckName                            ; 0x020b
	textpointer FlamethrowerDeckName                               ; 0x020c
	textpointer EarthquakeDeckName                                 ; 0x020d
	...
	textpointer GenesisBoosterText                               ; 0x03a8
	textpointer DiscoveryBoosterText                               ; 0x03a9
	textpointer RevelationBoosterText                              ; 0x03aa
	textpointer ExodusBoosterText		                           ; 0x03ab
	textpointer DrLindonNPCName                                    ; 0x03ac
    ...
    textpointer SpinAttackName
    textpointer SpinAttackDescription
    ...
    textpointer MagicDustName
    textpointer MagicDustDescription
    textpointer HyperReverseName
    textpointer HyperReverseDescription
    textpointer ButterflyName
    textpointer ButterfreeDescription
    textpointer WeedleName
    textpointer SpikeStabName
    textpointer SpikeStabDescription
    textpointer HairyBugName
    textpointer WeedleDescription
    textpointer KakunaName
    textpointer SecretePoisonName
    textpointer SecretePoisonDescription
    textpointer KakunaDescription
    textpointer BeedrillName
    textpointer TriplePoisonName
    textpointer TriplePoisonDescription
    textpointer PinMissileName
    textpointer QuadrupleX20Description
    textpointer PoisonBeeName
    textpointer BeedrillDescription
    textpointer OddishName
    textpointer HideName
    textpointer HideDescription
    ...
    textpointer StrangePowderName
    textpointer StrangePowderDescription
    textpointer StickyNectarName
    textpointer StickyNectarDescription
    textpointer StickyNectarDescriptionCont
    textpointer GloomDescription
    textpointer BellossomName
    textpointer SweetNectarName
    textpointer SweetNectarDescription
    textpointer FlowerDanceName
    textpointer FlowerDanceDescription
    textpointer FlowerDanceDescriptionCont
    textpointer FlowerName
    textpointer BellossomDescription
    textpointer ParasName
    textpointer SleepSporeName
    ...
    textpointer AllergicPollenDescription
    textpointer AllergicPollenDescriptionCont
    textpointer SleepPinchersName
    ...
    textpointer ScreechName
    textpointer ScreechDescription
    textpointer PoisonBiteName
    textpointer GolbatPoisonBiteDescription
    textpointer GolbatPoisonBiteDescriptionCont
    textpointer GolbatDescription
    textpointer CrobatName
    textpointer TriggeredPoisonName
    textpointer TriggeredPoisonDescription
    textpointer TriggeredPoisonDescriptionCont
    textpointer CrossAttackName
    textpointer CrossAttackDescription
    textpointer CrobatDescription
    textpointer ScytherName
    textpointer FuryCutterName
    textpointer FuryCutterDescription
    textpointer FuryCutterDescriptionCont
    ...
    textpointer Chikorita1Description
    textpointer GrowlName
    textpointer GrowlDescription
    textpointer RazorLeafName
    textpointer Chikorita2Description
    textpointer BayleefName
    textpointer PoisonpowderName
    textpointer MayInflictPoisonDescription
    textpointer PollenShieldName
    textpointer PollenShieldDescription
    textpointer Bayleef1Description
    textpointer SweetScentName
    textpointer SweetScent1Description
    textpointer DoubleRazorLeafName
    textpointer DoubleAttackX40Description
    textpointer Bayleef2Description
    textpointer MeganiumName
    textpointer HerbalScentName
    textpointer HerbalScentDescription
    textpointer BodySlamName
    textpointer MayInflictParalysisDescription
    textpointer HerbName
    textpointer Meganium1Description
    textpointer WildGrowthName
    textpointer WildGrowthDescription
    textpointer SoothingScentName
    textpointer InflictSleepDescription
    textpointer Meganium2Description
    textpointer LedybaName
    textpointer SupersonicName
    textpointer MayInflictConfusionDescription
    textpointer CometPunchName
    textpointer QuadrupleAttackX10Description
    textpointer FiveStarName
    textpointer LedybaDescription
    textpointer LedianName
    textpointer BatonPassName
    textpointer BatonPassDescription
    textpointer LedianDescription
    textpointer SpinarakName
    textpointer ScaryFaceName
    textpointer ScaryFaceDescription
    textpointer StringShotName
    textpointer StringSpitName
    textpointer Spinarak1Description
    textpointer PoisonStingName
    textpointer Spinarak2Description
    textpointer AriadosName
    textpointer SpiderWebName
    textpointer SpiderWebDescription
    textpointer AriadosPoisonBiteDescription
    textpointer AriadosPoisonBiteDescriptionCont
    textpointer LongLegName
    textpointer AriadosDescription
    textpointer HoppipName
    textpointer HopName
    textpointer SproutName
    textpointer SproutDescription
    textpointer CottonweedName
    textpointer Hoppip1Description
    textpointer RollingTackleName
    textpointer Hoppip2Description
    textpointer SkiploomName
    textpointer StunSporeName
    textpointer Skiploom1Description
    textpointer MysteriousPowderName
    textpointer Skiploom2Description
    textpointer JumpluffName
    textpointer SleepPowderName
    textpointer LeechSeedName
    textpointer LeechSeedDescription
    textpointer JumpluffDescription
    textpointer EvolutionsarySporeName
    textpointer EvolutionsarySporeDescription
    textpointer EvolutionsarySporeDescriptionCont
    textpointer SolarbeamName
    textpointer Jumpluff2Description
    ...
    textpointer MegaDrainDescriptionCont
    textpointer SeedName
    textpointer SunkernDescription
    textpointer SunfloraName
    textpointer PetalDanceName
    textpointer PetalDanceDescription
    textpointer SunName
    textpointer SunfloraDescription
    textpointer YanmaName
    textpointer ShockwaveName
    textpointer ShockwaveDescription
    textpointer ShockwaveDescriptionCont
    textpointer SwiftName
    textpointer SwiftDescription
    textpointer ClearWingName
    textpointer YanmaDescription
    textpointer PinecoName
    textpointer BurstName
    textpointer BurstDescription
    textpointer BurstDescriptionCont
    textpointer BagwormName
    textpointer PinecoDescription
    textpointer ShuckleName
    textpointer WithdrawName
    textpointer WithdrawDescription
    textpointer WrapName
    textpointer MoldName
    textpointer Shuckle1Description
    textpointer FinalBlowName
    textpointer FinalBlowDescription
    textpointer MegahornName
    textpointer SingleHornName
    textpointer HeracrossDescription
    textpointer CelebiName
    textpointer PsychicLeafName
    textpointer PsychicLeafDescription
    textpointer Celebi1Description
    textpointer MagbyName
    textpointer SputterName
	textpointer SputterDescription
    textpointer LiveCoalName
    textpointer MagbyDescription
	...
	textpointer CyndaquilLeerDescription
    textpointer FireMouseName
    textpointer Cyndaquil1Description
    textpointer FireworksName
    textpointer FireworksDescription
    textpointer QuickAttackName
    textpointer QuickAttackDescription
    textpointer Cyndaquil2Description
    textpointer QuilavaName
    textpointer EmberName
    textpointer EmberDescription
    textpointer FireWindName
    textpointer FireWindDescription
    textpointer VolcanoName
    textpointer Quilava1Description
	textpointer SmokescreenName
    textpointer SmokescreenDescription
    textpointer CharName
    textpointer CharDescription
	textpointer CharDescriptionCont
    textpointer Quilava2Description
    textpointer TyphlosionName
    textpointer FireRechargeName
    textpointer FireRechargeDescription
    textpointer FlameBurstName
    textpointer FlameBurstDescription
    textpointer Typhlosion1Description
    textpointer FireBoostName
    textpointer FireBoostDescription
    textpointer FlameWheelName
	textpointer FlameWheelDescription
    textpointer Typhlosion2Description
    textpointer SlugmaName
    textpointer FlareName
    textpointer MagmaRingName
    textpointer PreventRetreatDescription
    textpointer LavaName
    textpointer SlugmaDescription
    textpointer MagcargoName
    textpointer MagmaPoolName
    textpointer MagmaPoolDescription
    textpointer MagmaPoolDescriptionCont
    textpointer LavaFlowName
    textpointer LavaFlowDescription
    textpointer LavaFlowDescriptionCont
    textpointer MagcargoDescription
    textpointer HoundourName
    textpointer SmogName
    textpointer CollectFireName
    textpointer CollectFireDescription
    textpointer DarkName
    textpointer Houndour1Description
    textpointer EnteiName
    textpointer LegendaryBodyName
    textpointer EnteiLegendaryBodyDescription
    textpointer EnteiLegendaryBodyDescriptionCont
    textpointer MegaFlameName
    textpointer MegaFlameDescription
    textpointer Entei1Description
    textpointer HowlName
    textpointer HowlDescription
	textpointer HowlDescriptionCont
    textpointer SearingFlamesName
    textpointer SearingFlamesDescription
    textpointer Entei2Description
    textpointer HoOhName
    textpointer StokeName
    textpointer StokeDescription
    textpointer SacredFireName
    textpointer SacredFireDescription
    textpointer DiveBombName
    textpointer MayDoNothingDescription
    textpointer RainbowName
    textpointer HoOh1Description
    ...
    textpointer BellyDrumDescription
    textpointer WaterGunName
    textpointer PoliwhirlWaterGunDescription
    textpointer PoliwhirlDescription
    textpointer PolitoedName
    textpointer FrogSongName
    textpointer FrogSongDescription
	textpointer FrogSongDescriptionCont
    ...
    textpointer FinSmackName
    textpointer DoubleAttackX10Description
    textpointer GoldfishName
    textpointer GoldeenDescription
    textpointer SeakingName
    textpointer RisingLungeName
    textpointer TenPlus10AttackDescription
    textpointer HornSwipeName
    textpointer HornSwipeDescription
    textpointer SeakingDescription
    textpointer HorseaName
    textpointer FinSlapName
    textpointer FinSlapDescription
    textpointer DragonName
    textpointer HorseaDescription
    textpointer SeadraName
    textpointer BubbleName
    textpointer MudSplashsName
    textpointer MudSplashDescription
    textpointer SeadraDescription
    textpointer KingdraName
    textpointer AgilityName
    textpointer KingdraAgilityDescription
    textpointer DragonTornadoName
    textpointer DragonTornadoDescription
    textpointer Kingdra1Description
    textpointer GeneticMemoryName
    textpointer GeneticMemoryDescription
    textpointer TwisterName
    textpointer TwisterDescription
    textpointer Kingdra2Description
    textpointer JynxName
    textpointer FreezingKissGoodnightName
    textpointer StrangeDanceName
    textpointer StrangeDanceDescription
    textpointer StrangeDanceDescriptionCont
    textpointer HumanShapeName
    textpointer JynxDescription
    textpointer KabutoName
    textpointer MysteriousFossilName
    textpointer ReviveFriendsName
    textpointer ReviveFriendsDescription
	textpointer ReviveFriendsDescriptionCont
    textpointer WorkTogetherName
    textpointer WorkTogetherDescription
    textpointer ShellfishName
    textpointer KabutoDescription
    textpointer KabutopsName
    textpointer SlashName
    textpointer HydrocutterName
    textpointer HydrocutterDescription
    textpointer HydrocutterDescriptionCont
    textpointer KabutopsDescription
    textpointer TotodileName
    textpointer RageName
    textpointer TotodilesRageDescription
    textpointer BigJawName
    textpointer Totodile1Description
    textpointer TotodileLeerDescription
    textpointer FurySwipesName
    textpointer TripleAttackX10Description
    textpointer Totodile2Description
    textpointer CroconawName
    textpointer JawChompName
    textpointer JawChompDescription
    textpointer Croconaw1Description
    textpointer TackleDescription
    textpointer SweepAwayName
    textpointer SweepAwayDescription
    textpointer Croconaw2Description
    textpointer FeraligatrName
    textpointer BeserkName
    textpointer BeserkDescription
    textpointer ChompName
    textpointer ChompDescription
    textpointer Feraligatr1Description
    textpointer Feraligatr2Name
    textpointer DownpourName
    textpointer DownpourDescription
    textpointer RiptideName
    textpointer RiptideDescription
    textpointer Feraligatr2Description
    ...
    textpointer WaterFishName
    textpointer WooperDescription
    textpointer SlimeName
    textpointer SlimeDescription
    textpointer SlimeDescriptionCont
    textpointer Wooper2Description
    textpointer QuagsireName
    textpointer SurfName
    textpointer EarthquakeName
    textpointer EarthquakeDescription
    textpointer QuagsireDescription
    textpointer MudSlapName
    textpointer WhirlpoolDescription
    textpointer Quagsire2Description
    textpointer MarillName
    textpointer DefenseCurlName
    textpointer DefenseCurlDescription
    textpointer BubbleBombName
    textpointer BubbleBombDescription
    textpointer AquamouseName
    textpointer MarillsDescription
    textpointer AzumarillName
    textpointer BubbleShowerName
    textpointer BubbleShowerDescription
    textpointer AquarabbitName
    textpointer AzumarillDescription
    textpointer RemoraidName
    textpointer SharpshooterName
    textpointer SharphooterDescription
    textpointer JetName
    textpointer RemoraidDescription
    textpointer OctilleryName
    textpointer ConstrictName
    textpointer OctazookaName
    textpointer OctazookaDescription
    textpointer OctilleryDescription
    textpointer CorsolaName
    textpointer RecoverName
    textpointer RecoverDescription
    textpointer SpikeCannonName
    textpointer DoubleAttackX30Description
    textpointer CoralName
    textpointer CorsolaDescription
    textpointer MantineName
    textpointer UndulateName
    textpointer MantineUndulateDescription
    textpointer KiteName
    textpointer MantineDescription
    textpointer SwinubName
    textpointer PowderSnowName
    textpointer Swinub1Description
    textpointer PiloswineName
    textpointer FreezeName
    textpointer FreezeDescription
    textpointer BlizzardName
    textpointer BlizzardDescription
    textpointer SwineName
    textpointer Piloswine1Description
    textpointer QuilfishName
	textpointer NeedleStormName
	textpointer NeedleStormDescription
    textpointer BalloonName
    textpointer QuilfishDescription
    textpointer SuicuneName
    textpointer CrystalBodyName
    textpointer CrystalBodyDescription
    textpointer AuroraWaveName
    textpointer AuroraWaveDescription
    textpointer AuroraName
    textpointer Suicune1Description
    textpointer LegendaryBodyDescription
    textpointer LegendaryBodyDescriptionCont
    textpointer CrystalWaveName
    textpointer CrystalWaveDescription
    textpointer CrystalWaveDescriptionCont
    textpointer Suicune2Description
    textpointer PichuName
    textpointer PikachuName
    textpointer ZzzapDescription
    textpointer TinyMouseName
    textpointer PichuDescription
    textpointer PikachuAgilityDescription
    textpointer MouseName
    textpointer PikachuDescription
    textpointer RaichuName
    textpointer ThundershockName
    textpointer LightningStrikeName
    textpointer LightningStrikeDescription
    textpointer RaichuDescription
    textpointer ElekidName
    textpointer ElectabuzzName
    textpointer PlayfulPunchName
    textpointer PlayfulPunch1Description
    ...
    textpointer StaticElectricityDescription
    textpointer WoolName
    textpointer Mareep1Description
    textpointer ThunderJoltName
    textpointer ThunderJoltDescription
    textpointer Mareep2Description
    textpointer FlaaffyName
    textpointer DischargeName
    textpointer DischargeDescription
    textpointer DischargeDescriptionCont
    textpointer ElectricCurrentName
    textpointer ElectricCurrentDescription
    textpointer Flaaffy1Description
    textpointer ElectricPunchName
    textpointer TailShockName
    textpointer TailShockDescription
    textpointer Flaaffy2Description
    textpointer AmpharosName
    textpointer GigasparkName
    textpointer GigasparkDescription
    textpointer LightName
    textpointer Ampharos1Description
    textpointer AttractCurrentName
    textpointer AttractCurrentDescription
    textpointer GigavoltName
    textpointer GigavoltDescription
    textpointer Ampharos2Description
    textpointer ChinchouName
    textpointer FlailName
    textpointer ChinchouFlailDescription
    textpointer AnglerName
    textpointer Chinchou1Description
    textpointer PositiveIonName
    textpointer NegativeIonName
    textpointer NegativeIonDescription
    textpointer NegativeIonDescriptionCont
    textpointer Chinchou2Description
    textpointer LanturnName
    textpointer HydroelectricPowerName
    textpointer HydroelectricPowerDescription
    textpointer FloodlightName
    textpointer Lanturn1Description
    textpointer SubmergeName
    textpointer SubmergeDescription
    textpointer SubmergeDescriptionCont
    textpointer BlindingLightName
    textpointer Lanturn2Description
    textpointer RaikouName
    textpointer LightningBurstName
    textpointer LightningBurstDescription
    textpointer LightningBurstDescriptionCont
    textpointer LightningTackleName
    textpointer LightningTackleDescription
    textpointer ThunderName
    textpointer Raikou1Description
    textpointer RaikouLegendaryBodyDescription
    textpointer LightningSparkName
    textpointer Raikou2Description
    textpointer GeodudeName
    textpointer KnucklePunchName
    textpointer RockName
    textpointer GeodudeDescription
    textpointer GravelerName
    textpointer RockTumbleName
    textpointer RockTumbleDescription
    textpointer GravelerDescription
    textpointer OnixName
    textpointer OnixsRageDescription
    ...
    textpointer ReviveFossilName
    textpointer ReviveFossilDescription
    textpointer BindName
    textpointer SpiralName
    textpointer OmanyteDescription
    textpointer OmastarName
    textpointer SqueezeName
    textpointer SqueezeDescription
    textpointer SpikeBarrageName
    textpointer SpikeBarrageDescription
    textpointer OmastarDescription
    textpointer AerodactylName
    textpointer PrehistoricMemoryName
    textpointer PrehistoricMemoryDescription
    textpointer PrehistoricMemoryDescriptionCont
    textpointer FlyName
    textpointer AerodactylFlyDescription
    textpointer FossilName
    textpointer AerodactylDescription
    textpointer SudowoodoName
    textpointer SudowoodosFlailDescription
    textpointer RockThrowName
    textpointer ImitationName
    textpointer Sudowoodo1Description
    textpointer MimicName
    textpointer MimicDescription
    textpointer Sudowoodo2Description
    textpointer GligarName
    textpointer GligarDescription
    textpointer HardShellName
    textpointer HardShellDescription
    textpointer ToxicSalivaName
    textpointer ToxicSalivaDescription
    textpointer Shuckle2Description
    textpointer TakeDownName
    textpointer TakeDownDescription
    textpointer PigName
    textpointer Swinub2Description
    textpointer NapName
    textpointer NapDescription
    textpointer HighSpeedChargeName
    textpointer HighSpeedChargeDescription
    textpointer Piloswine2Description
    textpointer PhanpyName
    textpointer EndureName
    textpointer EndureDescription
    textpointer PhanpyDescription
    textpointer DonphanName
    textpointer DonphanFlailDescription
    textpointer RapidSpinName
    textpointer RapidSpinDescription
    textpointer RapidSpinDescriptionCont
    textpointer ArmorName
    textpointer DonphanDescription
    textpointer TyrougeName
    textpointer SmashPunchName
    textpointer ScuffleName
    textpointer TyrougeDescription
    textpointer HitmontopName
    textpointer DetectName
    textpointer DetectDescription
    textpointer TripleKickName
    textpointer TripleAttackX30Description
    textpointer HandstandName
    textpointer HitmontopDescription
    textpointer LarvitarName
    textpointer RockSkinName
    textpointer LarvitarDescription
    textpointer PupitarName
    textpointer SkullBashName
    textpointer DustDevilName
    textpointer DustDevilDescription
    textpointer PupitarDescription
    textpointer StarmieName
    textpointer ConfuseRayName
    textpointer CoreStreamName
    textpointer CoreStreamDescription
    textpointer CoreStreamDescriptionCont
    textpointer MysteriousName
    textpointer StarmieDescription
    textpointer SlowpokeName
    textpointer PsyshockName
    textpointer SlowpokeWaterGunDescription
    textpointer DopeyName
    textpointer SlowpokeDescription
    textpointer SlowkingName
    textpointer MindGamesName
    textpointer MindGamesDescription
    textpointer MindBlastName
    textpointer MindBlastDescription
    textpointer RoyalName
    textpointer SlowkingDescription
    textpointer SmoochumName
    textpointer PsykissName
    textpointer PsykissDescription
    textpointer KissName
    textpointer SmoochumDescription
    textpointer NatuName
    textpointer PeckName
    textpointer TelekinesisName
    textpointer NatuTelekinesisDescription
    textpointer LittleBirdName
    textpointer Natu1Description
    textpointer Natu2Description
    textpointer XatuName
    textpointer ProphecyName
    textpointer ProphecyDescription
    textpointer MysticName
    textpointer Xatu1Description
    textpointer EnergyCycleName
    textpointer EnergyCycleDescription
    textpointer SuperPsyName
    textpointer Xatu2Description
    textpointer EspeonName
    textpointer EeveeName
    textpointer PsychicName
    textpointer PsychicDescription
    textpointer Espeon1Description
    textpointer PsybeamName
    textpointer Espeon2Description
    textpointer MisdreavusName
    textpointer NightEyesName
    textpointer PerishSongName
    textpointer PerishSongDescription
    textpointer MisdreavusDescription
    textpointer WobbuffetName
    textpointer CounterName
    textpointer CounterDescription
    textpointer CounterDescriptionCont
    textpointer PatientName
    textpointer WobbuffetDescription
    textpointer GirafarigName
    textpointer GirafarigAgilityDescription
    textpointer LongNeckName
    textpointer GirafarigDescription
    textpointer LugiaName
    textpointer AerowingName
    textpointer AerowingDescription
    textpointer DivingName
    textpointer Lugia1Description
    textpointer TimeTravelName
    textpointer TimeTravelDescription
    textpointer PsychicDamageName
    textpointer PsychicDamageDescription
    textpointer Celebi2Description
    textpointer UmbreonName
    textpointer FeintAttackName
    textpointer FeintAttackDescription
    textpointer MoonlightName
    textpointer Umbreon1Description
    textpointer PursuitName
    textpointer PursuitDescription
    textpointer Umbreon2Description
    textpointer SneaselName
    textpointer BeatUpName
    textpointer BeatUpDescription
    textpointer SharpClawName
    textpointer Sneasel1Description
    textpointer SwipeName
    textpointer SwipeDescription
    textpointer Sneasel2Description
    textpointer PlunderName
    textpointer PlunderDescription
    textpointer Houndour2Description
    textpointer HoundoomName
    textpointer CrunchName
    textpointer CrunchDescription
    textpointer CrunchDescriptionCont
    textpointer FlamethrowerName
    textpointer FlamethrowerDescription
    textpointer Houndoom1Description
    textpointer DarkFlameName
    textpointer DarkFlameDescription
    textpointer BlackFlangName
    textpointer BlackFlangDescription
    textpointer Houndoom2Description
    textpointer MurkrowName
    textpointer MeanLookName
    textpointer MeanLookDescription
    textpointer DarknessName
    textpointer Murkrow1Description
    textpointer CallForFamilyName
    textpointer CallForFamilyDescription
    textpointer FlockAttackName
    textpointer FlockAttackDescription
    textpointer Murkrow2Description
    textpointer TyranitarName
    textpointer TrampleName
    textpointer TrampleDescription
    textpointer TrampleDescriptionCont
    textpointer TyranitarDescription
    textpointer MagnemiteName
    textpointer LockonName
    textpointer LockonDescription
    textpointer LockonDescriptionCont
    textpointer ElectricBoltName
    textpointer ElectricBoltDescription
    textpointer MagnetName
    textpointer MagnemiteDescription
    textpointer MagnetonName
    textpointer ElectromagneticPowerName
    textpointer ElectromagneticPowerDescription
    textpointer ElectromagneticPowerDescriptionCont
    ...
    textpointer SpikeDescription
    textpointer SpikeDescriptionCont
    textpointer ForretressDescription
    textpointer SteelixName
    textpointer TailCrushName
    textpointer TailCrushDescription
    textpointer IronSnakeName
    textpointer SteelixDescription
    textpointer ScizorName
    textpointer FalseSwipeName
    textpointer FalseSwipeDescription
    textpointer DoubleClawName
    textpointer ScissorsName
    ...
    textpointer ArmorBirdName
    textpointer Skarmory1Description
    textpointer FuryAttackName
    textpointer SkarmoryAgilityDescription
    textpointer Skarmory2Description
    textpointer CleffaName
    textpointer ClefairyName
    textpointer EeeeeeekName
    textpointer EeeeeeekDescription
    textpointer CleffaDescription
    textpointer DoubleslapName
    textpointer SquaredanceName
    textpointer SquaredanceDescription
    textpointer FairyName
    textpointer ClefairyDescription
    textpointer IgglybuffName
    textpointer GazeName
    textpointer GazeDescription
    textpointer IgglybuffDescription
    ...
    textpointer SoftboiledDescriptionCont
    textpointer HappinessName
    textpointer BlisseyDescription
    textpointer FarfetchdName
    textpointer GustName
    textpointer LeekJabName
    textpointer LeekJabDescription
    textpointer WildDuckName
    textpointer FarfetchdDescription
    textpointer EnergyEvolutionName
    textpointer EnergyEvolutionDescription
    textpointer EnergyEvolutionDescriptionCont
    ...
    textpointer PorygonTwoName
    textpointer EnergyConverterName
    textpointer EnergyConverterDescription
    textpointer EnergyConverterDescriptionCont
    textpointer DeltaBeamName
    textpointer DeltaBeamDescription
    textpointer PorygonTwoDescription
    textpointer SentretName
    textpointer ScoutName
    textpointer Sentret1Description
    textpointer ScoutDescription
    textpointer Sentret2Description
    textpointer FurretName
    textpointer LongBodyName
    textpointer FurretDescription
    textpointer HoothootName
    textpointer OwlName
    textpointer HoothootDescription
    textpointer NoctowlName
    textpointer GlaringGazeName
    textpointer GlaringGazeDescription
    textpointer WingAttackName
    textpointer NoctowlDescription
    textpointer TogepiName
    textpointer PoisonBarbName
    textpointer SpikeBallName
    textpointer TogepiDescription
    textpointer TogeticName
    textpointer SuperMetronomeName
    textpointer SuperMetronomeDescription
    textpointer SuperMetronomeDescriptionCont
    textpointer TogeticFlyDescription
    textpointer TogeticDescription
    textpointer AipomName
    textpointer PilferName
    textpointer PilferDescription
    textpointer TailWhipName
    textpointer LongTailName
    textpointer Aipom1Description
    textpointer GrabName
    textpointer GrabDescription
    textpointer TailPunchName
    textpointer Aipom2Description
    textpointer DunsparceName
    textpointer GlareName
    textpointer LandSnakeName
    textpointer DunsparceDescription
    textpointer SnubbullName
    textpointer RoarName
    textpointer RoarDescription
    textpointer LickName
    textpointer Snubbull1Description
    textpointer RagingHeadbuttName
    textpointer RagingHeadbuttDescription
    textpointer Snubbull2Description
    textpointer GranbullName
    textpointer RagingChargeName
    textpointer RagingChargeDescription
    textpointer GranbullDescription
    textpointer TeddiursaName
    textpointer NapTimeName
    textpointer NapTimeDescription
    textpointer LittleBearName
    textpointer TeddiursaDescription
    textpointer UrsaringName
    textpointer HeadpressName
    textpointer HeadpressDescription
    textpointer DoubleLariatName
    textpointer HibernantName
    textpointer UrsaringDescription
    textpointer DelibirdName
    textpointer PresentName
    textpointer PresentDescription
    textpointer PresentDescriptionCont
    textpointer DeliveryName
    textpointer DelibirdDescription
    textpointer StantlerName
    textpointer StompName
    textpointer StompDescription
    textpointer MystifyingHornsName
    textpointer BigHornName
    textpointer Stantler1Description
    textpointer TerrorizeName
    textpointer TerrorizeDescription
    textpointer OverheadTossName
    textpointer OverheadTossDescription
    textpointer Stantler2Description
    textpointer SmeargleName
    textpointer SketchName
    textpointer SketchDescription
    textpointer SketchDescriptionCont
    textpointer SmeargleDescription
    textpointer MiltankName
    textpointer MilkDrinkName
    textpointer MilkDrinkDescription
    textpointer MilkCowName
    textpointer MiltankDescription
    textpointer ElementalBlastName
    textpointer ElementalBlastDescription
    textpointer Lugia2Description
    textpointer RainbowBurnName
    textpointer RainbowBurnDescription
    textpointer HoOh2Description
    textpointer MasterBallName
    textpointer MasterBallDescription
    textpointer MaxReviveName
    textpointer MaxReviveDescription
    textpointer EnergyChargeName
    textpointer EnergyChargeDescription
    textpointer MaryName
    textpointer MaryDescription
    textpointer PokeGearName
    textpointer PokeGearDescription
    textpointer SuperEnergyRetrievalName
    textpointer SuperEnergyRetrievalDescription
    textpointer BillsTeleporterName
    textpointer BillsTeleporterDescription
    textpointer NewPokedexName
    textpointer NewPokedexDescription
    textpointer ProfessorElmName
    textpointer SuperScoopUpName
    textpointer SuperScoopUpDescription
    textpointer DoubleGustName
    textpointer DoubleGustDescription
    textpointer MooMooMilkName
    textpointer MooMooMilkDescription
    textpointer PokemonMarchName
    textpointer PokemonMarchDescription
    textpointer SuperRodName
    textpointer SuperRodDescription
    textpointer FossilEggName
    textpointer FossilEggDescription
	textpointer FossilEggDescriptionCont
    textpointer HyperDevolutionSprayName
    textpointer HyperDevolutionSprayDescription
    textpointer EnergyArkName
    textpointer EnergyArkDescription
    textpointer PokemonBreederFieldsName
    textpointer PokemonBreederFieldsDescription
    textpointer OldRodName
    textpointer OldRodDescription
    textpointer ThoughtWaveMachineName
    textpointer ThoughtWaveMachineDescription
	textpointer ThoughtWaveMachineDescriptionCont
    textpointer EnergyAmplifierName
    textpointer EnergyAmplifierDescription
	textpointer EnergyAmplifierDescriptionCont
    textpointer MagnifierName
    textpointer MagnifierDescription
    textpointer TeamRocketsEvilDeedsName
    textpointer TeamRocketsEvilDeedsDescription
    textpointer HealPowderName
    textpointer HealPowderDescription