...
; when KAKUNA is damaged after Secrete Poison has been used,
; the attacking Pokemon (turn holders arena Pokemon) becomes
; poisoned. ignore if damage taken is 0.
HandleSecretePoison_AgainstDamagingAttack:
