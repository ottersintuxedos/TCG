...
Raikou1CardGfx:: 
    INCBIN "gfx/cards/raikou1.2bpp"
    INCBIN "gfx/cards/raikou1.pal"
...
MagnifierCardGfx:
	INCBIN "gfx/cards/magnifier.2bpp"
	INCBIN "gfx/cards/magnifier.pal"
...
ShiningGyaradosCardGfx:
	INCBIN "gfx/cards/shininggyarados.2bpp"
	INCBIN "gfx/cards/shininggyarados.pal"

ShiningMagikarpCardGfx:
	INCBIN "gfx/cards/shiningmagikarp.2bpp"
	INCBIN "gfx/cards/shiningmagikarp.pal"